...
#' \code{c}, que detalha os valores dos componentes. Vide seção
...
#' observados do modelo linear dinâmico. Para mais informações sobre a
...
#' \code{\link{decompor}}.
#'
#' A função \code{\link{calcularElasticidades}} faz uso de
...
#' pela SPE/MF. Para utilizá-la, porém, é necessário ter todo o conjunto de
#' informações já preparado. Vide exemplo abaixo e seção
#' \code{\link{calcularElasticidades}} para mais informações.
#'
...
#' funções decompor.todos ou calcularElasticidades. Depois de estimados os modelos
